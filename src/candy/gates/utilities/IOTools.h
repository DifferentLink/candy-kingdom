 ...
 */
string getsij(const unsigned int i, const unsigned int j, const unsigned int k, const bool sign = false,
              const unsigned int offset = 0) {
    return (sign ? "-" : "") +  to_string(offset + (i - 1)*k + j);
}

string getxi(const vector<Var> &constraintVars, unsigned int i, const bool sign = false) {
 ...
 */
string atMostSEQ(const unsigned int offset, const vector<Var> &constraintVars, const unsigned int k) {
 ...
 * @return the constraint as a string to be appended to the corresponding formula
 */
string atMostSEQ(const unsigned int offset, const vector<Lit> &constraintLits, const unsigned int k) {
    vector<Var> vars;
 ...
 * @return the constraint as a string to be appended to the corresponding formula
 */
string atMostSEQ(const vector<Var> &allVars, const vector<Var> &constraintVars, const unsigned int k) {
